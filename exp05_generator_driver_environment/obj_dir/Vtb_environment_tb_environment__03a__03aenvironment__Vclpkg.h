...
class Vtb_environment_tb_environment__03a__03aenvironment : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "tb_environment::environment"; }
    VlClass* clone() const { return new Vtb_environment_tb_environment__03a__03aenvironment(*this); }
  ...
  public:
    Vtb_environment_tb_environment__03a__03aenvironment() = default;
    void init(Vtb_environment__Syms* __restrict vlSymsp, Vtb_environment_half_adder_if* vif);
