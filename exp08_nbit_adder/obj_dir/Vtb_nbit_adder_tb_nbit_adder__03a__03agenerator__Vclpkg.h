...
class Vtb_nbit_adder_tb_nbit_adder__03a__03agenerator : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "tb_nbit_adder::generator"; }
    VlClass* clone() const { return new Vtb_nbit_adder_tb_nbit_adder__03a__03agenerator(*this); }
  ...
  public:
    Vtb_nbit_adder_tb_nbit_adder__03a__03agenerator() = default;
