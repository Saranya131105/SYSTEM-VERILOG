...
void Vtb___024root__trace_chg_0_sub_0(Vtb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+2,(vlSelfRef.tb__DOT__Cin));
        bufp->chgBit(oldp+3,(((IData)(vlSelfRef.tb__DOT__A) 
                              ^ (IData)(vlSelfRef.tb__DOT__B))));
        bufp->chgBit(oldp+4,(((IData)(vlSelfRef.tb__DOT__A) 
                              & (IData)(vlSelfRef.tb__DOT__B))));
        bufp->chgBit(oldp+5,(((IData)(vlSelfRef.tb__DOT__Cin) 
                              ^ ((IData)(vlSelfRef.tb__DOT__A) 
                                 ^ (IData)(vlSelfRef.tb__DOT__B)))));
        bufp->chgBit(oldp+6,((((IData)(vlSelfRef.tb__DOT__A) 
                               & (IData)(vlSelfRef.tb__DOT__B)) 
