...
#endif
            VL_FATAL_MT("tb.sv", 3, "", "DIDNOTCONVERGE: Settle region did not converge after '--converge-limit' of 10000 tries");
        }
...
VL_ATTR_COLD void Vtb___024root___ctor_var_reset(Vtb___024root* vlSelf) {
    ...
    vlSelf->tb__DOT__A = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 891931256969079867ull);
    vlSelf->tb__DOT__B = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 18076046267505502401ull);
    vlSelf->tb__DOT__Cin = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 4053130143634338629ull);
    vlSelf->tb__DOT__HA_Sum = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 16096001914201977195ull);
    vlSelf->tb__DOT__HA_Carry = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 11840498853964755761ull);
    vlSelf->tb__DOT__FA_Sum = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 15726244961878104507ull);
    vlSelf->tb__DOT__FA_Cout = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 1966288130800826603ull);
