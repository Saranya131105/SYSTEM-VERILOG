...
class Vtb_full_adder_std__03a__03amailbox__Tz1 : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vtb_full_adder_std__03a__03amailbox__Tz1(*this); }
  ...
  public:
    Vtb_full_adder_std__03a__03amailbox__Tz1() = default;
    void init(Vtb_full_adder__Syms* __restrict vlSymsp, IData/*31:0*/ bound);
