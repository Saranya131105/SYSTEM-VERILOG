...
class Vtb_full_adder_tb_full_adder__03a__03adriver : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "tb_full_adder::driver"; }
    VlClass* clone() const { return new Vtb_full_adder_tb_full_adder__03a__03adriver(*this); }
  ...
  public:
    Vtb_full_adder_tb_full_adder__03a__03adriver() = default;
