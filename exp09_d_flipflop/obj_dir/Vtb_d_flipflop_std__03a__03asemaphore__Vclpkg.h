...
class Vtb_d_flipflop_std__03a__03asemaphore : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vtb_d_flipflop_std__03a__03asemaphore(*this); }
  ...
  public:
    Vtb_d_flipflop_std__03a__03asemaphore() = default;
    void init(Vtb_d_flipflop__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount);
