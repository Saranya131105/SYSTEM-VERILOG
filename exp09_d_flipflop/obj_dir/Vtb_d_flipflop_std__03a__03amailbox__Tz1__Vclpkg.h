...
class Vtb_d_flipflop_std__03a__03amailbox__Tz1 : public virtual VlClass {
  public:
    ...
    VlClass* clone() const { return new Vtb_d_flipflop_std__03a__03amailbox__Tz1(*this); }
  ...
  public:
    Vtb_d_flipflop_std__03a__03amailbox__Tz1() = default;
    void init(Vtb_d_flipflop__Syms* __restrict vlSymsp, IData/*31:0*/ bound);
