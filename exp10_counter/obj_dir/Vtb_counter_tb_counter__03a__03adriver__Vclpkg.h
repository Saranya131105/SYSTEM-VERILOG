...
class Vtb_counter_tb_counter__03a__03adriver : public virtual VlClass {
  public:
    ...
    // INTERNAL METHODS
    virtual const char* typeName() const { return "tb_counter::driver"; }
    VlClass* clone() const { return new Vtb_counter_tb_counter__03a__03adriver(*this); }
  ...
  public:
    Vtb_counter_tb_counter__03a__03adriver() = default;
