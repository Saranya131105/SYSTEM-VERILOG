...
void Vtb_counter_std__03a__03asemaphore::init(Vtb_counter__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter_std__03a__03asemaphore::new\n"); );
    // Body
...
void Vtb_counter_std__03a__03asemaphore::__VnoInFunc_put(Vtb_counter__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter_std__03a__03asemaphore::__VnoInFunc_put\n"); );
    // Body
    this->__PVT__m_keyCount = (this->__PVT__m_keyCount 
                               + keyCount);
}

VlCoroutine Vtb_counter_std__03a__03asemaphore::__VnoInFunc_get(Vtb_counter__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter_std__03a__03asemaphore::__VnoInFunc_get\n"); );
    // Locals
...
void Vtb_counter_std__03a__03asemaphore::__VnoInFunc_try_get(Vtb_counter__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount, IData/*31:0*/ &try_get__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter_std__03a__03asemaphore::__VnoInFunc_try_get\n"); );
    // Body
    {
...
void Vtb_counter_std__03a__03asemaphore::_ctor_var_reset(Vtb_counter__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vtb_counter_std__03a__03asemaphore::_ctor_var_reset\n"); );
    // Body
